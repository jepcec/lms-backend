...
export class UserEntity {
  ...
  get emailVerificationToken() {
    return this.props.email_verification_token ?? null;
  }
  set emailVerificationToken(value: string | null) {
    this.props.email_verification_token = value;
  }

  get passwordResetToken() {
    return this.props.password_reset_token ?? null;
  }
  set passwordResetToken(value: string | null) {
    this.props.password_reset_token = value;
  }
  ...
  set emailVerified(value: boolean) {
    this.props.email_verified = value;
  }

  get emailVerifiedAt() {
    return this.props.email_verified_at ?? null;
  }
  set emailVerifiedAt(value: Date | null) {
